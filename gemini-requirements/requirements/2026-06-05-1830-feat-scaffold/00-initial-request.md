...
- **Goal:** Start Task 1: `feat/scaffold`. One branch, one PR — scaffold only, not the full app.
- **Design Guidance**: Based on the provided UI screenshot, but make it "less edgy" (cleaner, softer, less aggressive tech-neon, more premium corporate/SaaS dashboard feel).
